...
# I choose to analyze the white_in_jail, which is the population of white people in jail
...
#trend over time chart
 white_trends <- ggplot(county_level, aes(x=year, y=white_jail_pop)) + geom_line() + geom_point()
 white_trends
